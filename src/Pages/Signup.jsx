...
function Signup() {
    ...
    function handleUserInput(e) {
        ...
        //e.target gives us targeted html element
        setSignupData({
            ...signupData,
            [name]: value
        })
    ...
    async function createNewAccount(event) {
        ...
        if(!signupData.email.match(/^[^\.\s][\w\-]+(\.[\w\-]+)*@([\w-]+\.)+[\w-]{2,}$/gm)){
            toast.error("Invalid email id")
            return;
            //email validation regex search on google
        }
   ...
   <Homelayout>
        <div className="flex overflow-x-auto items-center justify-center h-[100vh]">
            <form noValidate onSubmit={createNewAccount} className='flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]'> 
              <h1 className='text-center text-2xl font-bold'>Registritation Page</h1>
              ...
              <input 
                  ...
                  className='bg-transperent px-2 py-1 border'
